...
public class CheckBox {
	...
	private void initialize() {
		...
		frmCheckbox.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		frmCheckbox.getContentPane().setLayout(null);
		frmCheckbox.setIconImage(Toolkit.getDefaultToolkit().getImage(Calculadora.class.getResource("/img/f.JPG")));
		...
		lblQueTrae.setBounds(43, 147, 309, 35);
